...
const HomeLeftSide = ({}) => {
  ...
  let rightList = [
    { key: t('nationality'), value: "Armenin" },
    { key: t('adress'), value: "Armenia Armavir" },
    { key: "Mail", value: "vahag.kostanyan974@gmail.com" },
    { key: t('position'), value: "Junior" },
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Heading
            as="h1" size={language == "am" ? "xl" : "2xl"}  borderBottom='1px solid ' fontWeight={100}
